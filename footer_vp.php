...
<footer id="main-footer" class="style-light">
                            ...
                            <div class="widget widget_recent_entries">
                               ...
                               <!--  <ul>   <?php
                                ...
                                <?php if ($row_rsMedia['type'] == "news") { ?>
                                    <li>
                                        <a href="berger_ftp/media-full.php?bp=<?php echo $row_rsMedia['sn']; ?>&cmd=<?php echo $bpn->slug($row_rsMedia['title']); ?>"><?php echo $row_rsMedia['title']; ?></a>
                ...
                <div class="bottom-footer">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright"> © Copyright 2017. All rights reserved. <a href="/admin">WEBAdmin</a> | <a href="berger_ftp/sitemap">SiteMap</a> |  Developed by <a href="http://www.taglogictech.com" target="_blank"><img src="berger_ftp/img/TAG.png" width="40" height="15" alt="TAG Logic Tech"/>™ </a>. </div>
                            </div><!-- /col-md-12 -->
                        </div><!-- /row -->
                    </div><!-- /container -->
                </div><!-- /bottom-footer -->
